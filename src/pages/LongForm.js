...
const LongForm = () => {
  ...
  return (
    <div className="bg-teal-700 h-screen w-screen flex justify-center items-center overflow-auto">
      <form
        className="bg-teal-800 shadow-lg p-10 rounded-md flex flex-wrap gap-3 max-w-3xl justify-between"
        onSubmit={submit}
      >
